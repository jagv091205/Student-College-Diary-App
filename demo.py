...
# splash_window.configure(bg="maroon")

# # Display image on splash screen
# label = tk.Label(splash_window, image=photo, bg="maroon")
# label.image = photo  # Keep a reference to the image object
# label.place(relx=0.5, rely=0.5, anchor="center")

# # Close splash screen after 4 seconds
# root.after(4000, close_splash)
...
# create_button("images/button10.jpg", 2, 1, open_CareerWorkshop_window)
# create_button("images/button11.jpg", 2, 2, open_Certificate_window)
# create_button("images/button12.jpg", 2, 3, open_message_window)

# create_button("images/button13.jpg", 3, 0, open_Railway_Concession_Apply_window)
# create_button("images/button14.jpg", 3, 1, open_ITLE_window)
...
for i in range(50):
    label = tk.Label(frame, text=f"Label {i}", bg="white")
    label.pack(pady=10)
